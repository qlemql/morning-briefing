...
/**
 * Client-side subscribe page wrapper.
 * Splits into iOS-native (simple info) vs web (full subscribe UI).
 * App Store compliance: iOS must show no pricing, payment, or trial references.
 */
export default function SubscribeClient() {
  ...
  // Suspend render until we know the platform — prevents web UI flashing on iOS
  if (isNative === null) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-[#111111]" aria-hidden="true" />
    );
  }

  // iOS native: simple info page, no pricing/payment UI (App Store compliance)
  if (isNative) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-[#111111] px-4 py-12">
        <div className="max-w-lg mx-auto text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-base leading-relaxed mb-2">
            앱에서는 모든 브리핑을 무료로 이용하실 수 있습니다.
          </p>
          <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed mb-8">
            매일 아침 3분, AI가 정리하는 경제·투자·생활 뉴스를 즐겨보세요.
          </p>
          <Link
            href="/"
