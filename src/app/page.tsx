  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#111111] transition-colors">
      ...
      >
        ...
        {/* 읽었으면 → 학습 진입 (오늘 뉴스 레슨 + 기초 개념 계산기, 분리) */}
        {briefing && !loading && (
          <div className="space-y-2">
            ...
            <Link
              href="/learn/basics"
              onClick={() => hapticLight()}
              className="block rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-[#1c1c1e] p-4 active:scale-[0.99] transition-transform"
            >
              <div className="flex items-center gap-3">
                <span className="text-2xl" aria-hidden="true">🧮</span>
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-bold text-gray-800 dark:text-gray-100">기초 개념 계산기</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">금리·복리·인플레이션·환율 — 늘 유용한 4가지</p>
                </div>
